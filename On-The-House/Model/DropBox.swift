...
//  On-The-House
//
//  Created by beier nie on 2/4/18.
...
class DropBox: UIView {
    ...
    init(parentVC: UIViewController, title: String, items: [String], frame: CGRect) {
       ...
       // self.boxButton.
        ...
        self.boxTitle.layer.borderWidth = 1.0
        

        self.boxTitle.layer.cornerRadius = 4
        
        self.boxTitle.layer.borderColor = UIColor.lightGray.cgColor
    ...
    override func layoutSubviews() {
        ...
        self.boxTitle.frame.size = CGSize(width: self.frame.size.width - 30, height: self.frame.size.height - 15)
...
extension DropBox: UITableViewDelegate {
...
extension DropBox: UITableViewDataSource {
